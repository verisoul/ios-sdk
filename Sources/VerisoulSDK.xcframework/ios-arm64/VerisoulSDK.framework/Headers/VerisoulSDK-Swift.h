...
#ifndef VERISOULSDK_SWIFT_H
#define VERISOULSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VerisoulSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11VerisoulSDK8Verisoul")
@interface Verisoul : NSObject
...
@interface VerisoulWebView (SWIFT_EXTENSION(VerisoulSDK)) <WKScriptMessageHandler>
